...
<ul class="nav nav-tabs">
	<li class="active"><a class="text-blue" href="#dat" data-toggle="tab">SK Kerja</a></li>
	<li><a class="text-blue" href="#dat1" data-toggle="tab">Riwayat SK Kerja</a></li>
</ul>
...
<section id="new">
	<div class="box box-solid box-primary">
		...
		Daftar SK Kerja Aktif PT. Zaman Teknindo</h3>		
		</div>		
	<div class="box-body">
...
<div class="box box-solid box-info">
		...
		<h3 class="btn btn disabled box-title">
		<i class="glyphicon glyphicon-briefcase"></i>
		Daftar Riwayat Kerja di PT. Zaman Teknindo</h3>			
		</div>		
	<div class="box-body">
	<table id="example1" class="table table-bordeblue table-striped">
<thead>
...
$Kode = $k['no_sk'];?>
	...
	<td><?php echo format_angka($k['gaji']); ?></td>
	<td align="center">	
	<a class="btn btn-xs btn-warning" href="<?php echo $aksi ?>?module=sk_krj&aksi=hapus&no_sk=<?php echo $k['no_sk'];?>"  alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA <?php echo $Kode; ?>	?')"> <i class="glyphicon glyphicon-trash"></i></a>
	</td>
	<?php
	}
	?>
