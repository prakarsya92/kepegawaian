      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         ...
         <ul class="sidebar-menu">
			...
			<li><a href='?module=sk_krj' ><i class="glyphicon glyphicon-briefcase"></i><span>Daftar SK Kerja</span></a></li>
			<li><a href='?module=prestasi' ><i class="glyphicon glyphicon-thumbs-up"></i><span>Daftar Prestasi Pegawai</span></a></li>
			<li><a href='?module=hukuman' ><i class="glyphicon glyphicon-thumbs-down"></i><span>Daftar Hukuman Pegawai</span></a></li>
	...
	<?php include "isi.php";?>        		
       ...
       <footer class="main-footer">
        <div class="pull-right hidden-xs">
          Sistem Kepegawaian PT. Zaman Teknindo <b>Version</b> 1.0
        </div>
