...
<html>
  ...
  <body class="skin-blue layout-top-nav" style="background-color:white">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              <a href="../../../../../aset//index2.html" class="navbar-brand"><b>Sistem Kepegawaian</b>&nbsp; PT. Zaman Teknindo</a>
            ...
            <!-- Navbar Right Menu -->
              <div class="navbar-custom-menu">
				...
				<button class="btn "onClick="<script>window.close();</script>" value="Tutuplah"/>
                </li>
				</ul>
